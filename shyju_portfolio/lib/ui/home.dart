...
import 'package:shyju_portfolio/constants/strings.dart';
import 'package:shyju_portfolio/constants/text_styles.dart';
import 'package:shyju_portfolio/models/education.dart';
import 'package:shyju_portfolio/utils/screen/screen_utils.dart';
import 'package:shyju_portfolio/widgets/responsive_widget.dart';
    ...
    return Row(
      ...
      children: <Widget>[
        GestureDetector(
          onTap: () {
            html.window
                .open("https://www.linkedin.com/in/shyjuzz/", "LinkedIn");
          },
          child: Image.network(
            Assets.linkedin,
            color: Color(0xFF45405B),
